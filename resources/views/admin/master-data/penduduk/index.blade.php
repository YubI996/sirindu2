...
<style>
    ...
    :root {
        --st-primary:#0066cc; --st-primary-dark:#0052a3; --st-bg:#f5f7f8; --st-surface:#ffffff;
    ...
    .md-header__icon { display:flex; align-items:center; justify-content:center; width:48px; height:48px; background:rgba(4,120,87,.1); border-radius:12px; color:#047857; }
    ...
    .st-btn { display:inline-flex; align-items:center; gap:8px; padding:0 18px; height:42px; border-radius:var(--st-radius); font-family:'Manrope',sans-serif; font-weight:700; font-size:.8125rem; border:1.5px solid transparent; cursor:pointer; transition:all .2s ease; text-decoration:none !important; white-space:nowrap; }
    ...
    .st-card__header { background:linear-gradient(135deg,#047857 0%,var(--st-primary) 100%); padding:14px 24px; display:flex; align-items:center; justify-content:space-between; }
    ...
    .st-card .dataTables_wrapper .dataTables_filter input { height:38px; padding:0 14px; border-radius:var(--st-radius); border:1px solid #cbd5e1; background:#fff; font-size:.8125rem; font-family:'Manrope',sans-serif; min-width:250px; }
    .st-card .dataTables_wrapper .dataTables_filter input:focus { border-color:var(--st-primary); box-shadow:0 0 0 3px rgba(0,102,204,.12); outline:none; }
    .st-card .dataTables_wrapper .dataTables_length select { height:32px; padding:0 28px 0 10px; border-radius:8px; border:1px solid #cbd5e1; font-family:'Manrope',sans-serif; font-weight:600; font-size:.8125rem; }
    ...
    .st-card .badge { display:inline-flex; align-items:center; padding:4px 12px; border-radius:9999px; font-size:.6875rem; font-weight:700; font-family:'Manrope',sans-serif; border:1px solid transparent; }
    ...
    .st-card .dataTables_wrapper .dataTables_paginate .paginate_button { min-width:32px; height:32px; display:inline-flex; align-items:center; justify-content:center; border-radius:8px !important; border:1px solid var(--st-border) !important; background:#fff !important; color:var(--st-text-muted) !important; font-size:.8125rem; font-weight:600; font-family:'Manrope',sans-serif; margin:0 2px; padding:0 8px !important; }
    ...
    .st-card .dataTables_wrapper .dataTables_info { font-size:.8125rem; font-weight:500; color:var(--st-text-muted); font-family:'Manrope',sans-serif; padding:16px 24px; }
    ...
    .st-modal .modal-footer .btn { border-radius:var(--st-radius); font-family:'Manrope',sans-serif; font-weight:700; font-size:.8125rem; padding:8px 20px; }
    ...
    .st-form-group input, .st-form-group select { width:100%; padding:10px 14px; border-radius:var(--st-radius); border:1px solid #cbd5e1; background:#f8fafc; color:#334155; font-family:'Manrope',sans-serif; font-size:.875rem; font-weight:500; }
    .st-form-group input:focus, .st-form-group select:focus { outline:none; border-color:var(--st-primary); box-shadow:0 0 0 3px rgba(0,102,204,.12); }
    ...
    .filter-bar select { height:38px; padding:0 12px; border-radius:var(--st-radius); border:1px solid #cbd5e1; font-family:'Manrope',sans-serif; font-size:.8125rem; font-weight:600; min-width:140px; }
