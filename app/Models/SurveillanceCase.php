...
class SurveillanceCase extends Model
{
    ...
    protected $fillable = [
        ...
        'tanggal_nyeri_sendi',
        'tanggal_lemas',
        'tanggal_kehilangan_nafsu_makan',
        'tanggal_mata_merah',
        'tanggal_pembengkakan_kelenjar',
        'tanggal_kejang',
    ...
    protected $casts = [
        ...
        'tanggal_batuk' => 'date',
        'tanggal_pilek' => 'date',
        'tanggal_sakit_kepala' => 'date',
        'tanggal_mual' => 'date',
        'tanggal_muntah' => 'date',
        'tanggal_diare' => 'date',
        'tanggal_ruam' => 'date',
        'tanggal_nyeri_otot' => 'date',
        'tanggal_nyeri_sendi' => 'date',
        'tanggal_lemas' => 'date',
        'tanggal_kehilangan_nafsu_makan' => 'date',
        'tanggal_mata_merah' => 'date',
        'tanggal_pembengkakan_kelenjar' => 'date',
        'tanggal_kejang' => 'date',
        'tanggal_penurunan_kesadaran' => 'date',
