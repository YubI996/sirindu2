...
class ImportHasilLabJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        try {
            ...
            $import = new HasilLabImport($this->importLog->user_id);
            ...
            Log::error("ImportHasilLabJob gagal [{$this->importLog->id}]: " . $e->getMessage());
